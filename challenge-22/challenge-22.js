  (function(){
    ...
    */
   // ?
    var pessoa1 = {name: 'Uítalo', lastName:'Souza'};
    var pessoa2 = {name: 'Nilza', lastName: 'Santos'};
   /*
  ...
  function sum(){
    ...
    var resultado = Array.prototype.reduce.call(arguments, function(acumulado, atual){
 ...
 console.log(sum(2, 4, 9, 4));
 console.log(sum(23, 12, 5));
 // ?
 ...
 */
console.log('Entre com alguns números que serão somados.');
...
// ?
console.log(justNumbers('1sdaeqe1T4L0'));
